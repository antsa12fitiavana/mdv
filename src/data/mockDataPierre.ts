...
export const mockLotsPierre: LotPierre[] = [
  ...
  {
    id: "LOT-PIE-2025-0006",
    filiere: "pierre",
    stoneType: "Émeraude",
    family: "precious",
    quantity: 18.7,
    unit: "carat",
    declaredAt: "2025-12-03T08:00:00",
    declaredBy: "P001",
    currentOwner: "P001",
    status: "available",
    qrCode: "QR-PIE-0006",
  ...
  {
    id: "LOT-PIE-2025-0007",
    filiere: "pierre",
    stoneType: "Améthyste",
    family: "semi_precious",
    quantity: 250,
    unit: "gram",
    declaredAt: "2025-12-04T11:00:00",
    declaredBy: "P001",
    currentOwner: "P002",
    status: "available",
    qrCode: "QR-PIE-0007",
  ...
  {
    id: "LOT-PIE-2025-0008",
    filiere: "pierre",
    stoneType: "Saphir jaune",
    family: "precious",
    quantity: 32.5,
    unit: "carat",
    declaredAt: "2025-12-05T09:30:00",
    declaredBy: "P002",
    currentOwner: "P003",
    status: "transformed",
    qrCode: "QR-PIE-0008",
    ...
    color: "Jaune canari",
    clarity: "VVS",
    notes: "Taille cushion",
  },
  {
    id: "LOT-PIE-2025-0009",
    filiere: "pierre",
    stoneType: "Rubis étoilé",
    family: "precious",
    quantity: 12.8,
    unit: "carat",
    declaredAt: "2025-11-18T10:00:00",
    declaredBy: "P003",
    currentOwner: "P004",
    status: "exported",
    qrCode: "QR-PIE-0009",
    gpsLat: -18.9140,
    gpsLon: 47.5365,
    notes: "Exporté vers Bangkok",
  },
  {
    id: "LOT-PIE-2025-0010",
    filiere: "pierre",
    stoneType: "Quartz rose",
    family: "crystal",
    quantity: 500,
    unit: "gram",
    declaredAt: "2025-12-06T08:00:00",
    declaredBy: "P001",
    currentOwner: "P001",
    status: "declared",
    qrCode: "QR-PIE-0010",
...
export const mockTransactionsPierre: TransactionPierre[] = [
  ...
  },
  {
    ...
    confirmedAt: "2025-12-04T11:35:00",
    lots: ["LOT-PIE-2025-0007"],
  },
  {
    id: "TXN-PIE-2025-0004",
    sellerId: "P002",
    buyerId: "P003",
    status: "paid",
    ...
    confirmedAt: "2025-12-05T10:05:00",
    lots: ["LOT-PIE-2025-0008"],
  },
  {
    id: "TXN-PIE-2025-0005",
    sellerId: "P003",
    buyerId: "P004",
    status: "paid",
    ...
    confirmedAt: "2025-11-19T09:10:00",
    lots: ["LOT-PIE-2025-0009"],
  },
  {
    id: "TXN-PIE-2025-0006",
    sellerId: "P003",
    buyerId: "P004",
