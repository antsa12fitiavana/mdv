...
import { Package, TrendingUp, ScanLine, HandCoins, Link2, Gem, Briefcase } from "lucide-react";

export default function PierreNegociantHome() {
    const { user } = useAuth();
    const { t } = useLanguage();
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-slate-500 mt-1">{t("dashboard")} - Négociant {t("filierePierre")}</p>
            </div>
                ...
                <Card className="border-slate-200 shadow-sm">
                    <CardContent className="pt-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xs text-slate-500 uppercase">Affaires</p>
