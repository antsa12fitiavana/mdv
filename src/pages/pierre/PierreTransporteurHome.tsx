...
export default function PierreTransporteurHome() {
    const { user } = useAuth();
    const { t } = useLanguage();
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-slate-500 mt-1">{t("dashboard")} - Transporteur {t("filierePierre")}</p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
                <Button onClick={() => navigate("/dashboard/transport")} className="bg-blue-600 hover:bg-blue-700 text-white">
